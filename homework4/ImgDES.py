...
import os
import base64
from homework4.pyDes import *


def encrypt(msg, key):
    return des(key, CBC, b"\0\0\0\0\0\0\0\0", pad=None, padmode=PAD_PKCS5).encrypt(msg)


def decrypt(cph, key):
    return des(key, CBC, b"\0\0\0\0\0\0\0\0", pad=None, padmode=PAD_PKCS5).decrypt(cph, padmode=PAD_PKCS5)
...
if __name__ == '__main__':
    ...
    if len(key) != 8:
        print("Invalid DES key size. Key must be exactly 8 bytes long.")
        exit()
